function[number_hits,three_channel_output_combined_sorted]= dld_read_5channels_reconst_multi_a(filename_call,normalise_time_flag_call,reconst_4_corners_nomcp_flag_call,reconst_3_corners_flag_call)
...
three_channel_output_combined = cat(1,three_channel_output_5trigs,three_channel_output_5trigs_multi,three_channel_output_mcp_reconst,three_channel_output_4corners);
...
number_hits = length(three_channel_output_combined_sorted(:,1));
